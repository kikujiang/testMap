...
public class ToBeCompletedFragment extends Fragment {
    ...
    public static ToBeCompletedFragment newInstance(ArrayList<TaskBean> dataList) {
        ToBeCompletedFragment fragment = new ToBeCompletedFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(list != null && list.size() > 0){
            ...
            TaskAdapter adapter = new TaskAdapter(getActivity(),list,Constants.TYPE_TASK_TO_BE_FINISH);
